...
setInterval(function() {
  stepper.rpm(65).cw().accel(1600).decel(1600).step(250, function() {
    console.log("Maju");
    setTimeout(function() {
    stepper.rpm(65).ccw().accel(1600).decel(1600).step(250, function() {
      console.log("Mundur");
    });
  }, 5000);
...
/*stepper.rpm(300).ccw().accel(6400).decel(6400).step(20000, function() {
      console.log("Mundur");
    });*/
});
// @markdown
